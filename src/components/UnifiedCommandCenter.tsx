  ...
  return (
    <div className="min-h-screen grid-bg">
      ...
      <main className="mx-auto w-[90%] md:w-[85%] pb-24 pt-6">
        ...
        {/* ROW 1: ACTIVE TARGETS & LIVE TACTICAL MAP */}
        <section className="grid gap-6 grid-cols-1 lg:grid-cols-[30%_70%]">
          {/* Active Targets & Events Card */}
          <div>
        ...
        {/* ROW 2: WHAT-IF CONSOLE & ROUTE STACK */}
        <section className="mt-6 grid gap-6 grid-cols-1 lg:grid-cols-[65%_35%]">
          {/* What-If Console & Projection Output (Merged Card) */}
          <div className="rounded-2xl border border-border panel-glass overflow-hidden flex flex-col h-[460px]">
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-border h-full">
              ...
              <div className="p-5 flex flex-col justify-between h-full min-h-0">
                <div className="flex-1 flex flex-col min-h-0">
                  ...
                  <div className="flex-1 mb-4 overflow-y-auto rounded-lg border border-border bg-background/80 p-3 text-mono text-[11px] leading-relaxed flex flex-col gap-2 min-h-0">
                ...
                <div className="flex-1 flex flex-col justify-between h-full min-h-0">
                  <div>
                    ...
                    {queryResponse ? (
                      ...
                      <div className="rounded-xl border border-dashed border-border bg-input/10 p-5 text-center text-xs text-muted-foreground my-8 flex flex-col items-center justify-center flex-1">
