...
def load_and_clean_data(file_path):
    ...
    # Clean outlier durations using IQR like in evaluate_models.py
...
def train_impact_engine(df, features):
    ...
    # Clip duration_mins to a max of 3 hours (180 mins) to filter out long-running database entry anomalies
    y_clipped = np.clip(y, 0, 180)
